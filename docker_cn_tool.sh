...
function docker_install
{
    ...
    if [ -n "$lnx_ver" ];then
        ...
        apt install -y docker-ce=5:18.09.1~3-0~ubuntu-xenial
        #安装docker-compose
        echo '开始安装docker-compose'
        sudo curl -L "https://ghproxy.net/https://github.com/docker/compose/releases/download/v2.27.0/docker-compose-$(uname -s)-$(uname -m)" -o /usr/local/bin/docker-compose
        ...
        #安装docker-compose
        echo '开始安装docker-compose'
        curl -L "https://ghproxy.net/https://github.com/docker/compose/releases/download/v2.27.0/docker-compose-$(uname -s)-$(uname -m)" -o /usr/local/bin/docker-compose
        chmod +x /usr/local/bin/docker-compose
        echo '========================================================='
    fi
}
